...
import com.qianyvbytehub.auth.infra.basic.dao.AuthUserDao;
import com.qianyvbytehub.auth.infra.basic.entity.AuthUser;
import com.qianyvbytehub.auth.infra.basic.service.AuthUserService;
...
public class AuthUserServiceImpl implements AuthUserService {
    ...
    public List<AuthUser> queryByCondition(AuthUser authUser) {
        return this.authUserDao.queryAllByCondition(authUser);
    }
}
